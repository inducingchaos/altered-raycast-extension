...
export const TEMP_PREFIXED_FIELDS = ["alias", "validated", "datasets", "devNotes", "priority", "sensitive"]
...
export const ALWAYS_VISIBLE_METADATA = ["content", "alias", "datasets", "validated", "devNotes", "priority", "sensitive"]
